...
class PartsBrandCategory extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::deleting(function ($partsBrandCategory){
            if (!empty($partsBrandCategory->partsBrandCategories))
            {
                $partsBrandCategory->partsBrandCategories->each->delete();
            }
            if (!empty($partsBrandCategory->partsProducts))
            {
                $partsBrandCategory->partsProducts->each->delete();
            }
        });
    }
