            ...
            <div class="wrap-box-news">
                ...
                <div class="right-list anim-from-bottom" trigger-anim=".trigger-news" delay="0.8">
                    @foreach($blogs->skip(1) as $blog)
                        <a href="{{ route('frontend.blog-details', ['blog_id' => $blog->id, 'titile' => str_replace(' ', '-', $blog->title)]) }}" class="list" style="width: 100%">
                            <figure>
                                <img src="{{ asset(!empty($blog->image) ? $blog->image : 'frontend/assets/contents/uyynP93oEV.jpg') }}" alt="" style="width: 227.19px; height: 140.19px" />
                            </figure>
                            <div class="text ms-6">
                                <p>{{ $blog->title ?? '' }}</p>
                                <div class="caption-small">
