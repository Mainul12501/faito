                ...
                <div class="left-box">
                    <div class="slider-big">
                        @if(!empty($product->sub_images))
                            @foreach(json_decode($product->sub_images) as $subImage)
                                <div class="list">
                                    <figure><img src="{{ asset(isset($subImage) ? $subImage : 'frontend/assets/contents/ouPkud6jhV.png') }}" alt="" style="height: 480px"></figure>
                                </div>
                            @endforeach
                        @else
                            <div class="list">
                    ...
                    <div class="slider-thumbnail">
                        @if(!empty($product->sub_images))
                            @foreach(json_decode($product->sub_images) as $subImage)
                                <div class="list">
                                    <figure><img src="{{ asset(!empty($subImage) ? $subImage : 'frontend/assets/contents/ouPkud6jhV.png') }}" alt="" ></figure>
                                </div>
                            @endforeach
                        @else
                            <div class="list">
                    ...
                    <div class="marketplace">
                        ...
                        @if(!empty($product->marketVerdors))
                            @foreach($product->marketVerdors as $marketVerdor)
                                <a href="{{ $marketVerdor->pivot->link }}" target="_blank" rel="nofollow"><img src="{{ asset(!empty($marketVerdor->logo) ? $marketVerdor->logo : 'frontend/assets/images/content/ecom-1.png') }}" alt="" style="height: 32px" /></a>
                            @endforeach
                        @endif
