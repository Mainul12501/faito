                                        ...
                                        <div class="filter-list brand-select-tag">
                                            @if(!empty($bikeBrands))
                                                @foreach($bikeBrands as $index => $bikeBrand)
                                                    <a href="#" data-value="{{ $bikeBrand->id }}" @if(isset($_GET['brand'])) @if($_GET['brand'] == $bikeBrand->id) class="selected" @endif @endif >
                                        ...
                                        <div class="filter-list motortype-select-tag">
                                            @if(!empty($motorTypes))
                                                @foreach($motorTypes as $motorType)
                                                    <a href="#" data-value="{{ $motorType->id }}" @if(isset($_GET['motortype'])) @if($_GET['motortype'] == $motorType->id) class="selected" @endif @endif >
                                        ...
                                        <div class="filter-list motor-select-tag">
                                            @if(!empty($motorBikes))
                                                @foreach($motorBikes as $motorBike)
                                                    <a href="#" data-value="{{ $motorBike->id }}" @if(isset($_GET['motor'])) @if($_GET['motor'] == $motorBike->id) class="selected" @endif @endif >
                                        ...
                                        <div class="filter-list enginesize-select-tag">
                                            @if(!empty($engineSizes))
                                                @foreach($engineSizes as $engineSize)
                                                    <a href="#" data-value="{{ $engineSize->id }}"  @if(isset($_GET['enginesize'])) @if($_GET['enginesize'] == $engineSize->id) class="selected" @endif @endif  @if(isset($_GET['brand'])) @if($_GET['brand'] == $bikeBrand->id) class="selected" @endif @endif >
                                        ...
                                        <div class="filter-list year-select-tag">
                                            @if(!empty($bikeYearVersions))
                                                @foreach($bikeYearVersions as $bikeYearVersion)
                                                    <a href="#" data-value="{{ $bikeYearVersion->id }}"  @if(isset($_GET['year'])) @if($_GET['year'] == $bikeYearVersion->id) class="selected" @endif @endif >
                                        ...
                                        <div class="filter-list category-select-tag">
                                            @if(!empty($partsCategories))
                                                @foreach($partsCategories as $partsCategory)
                                                    <a href="#" data-value="{{ $partsCategory->id }}" @if(isset($_GET['category'])) @if($_GET['category'] == $partsCategory->id) class="selected" @endif @endif >
...
@push('script')
    ...
    <script>
        $(function () {
            @if(isset($_GET['brand']))
                setSelectLevel('.brand-select-tag', '#brandLabel');
            @endif
            @if(isset($_GET['motortype']))
                setSelectLevel('.motortype-select-tag', '#motortypeLabel');
            @endif
            @if(isset($_GET['motor']))
                setSelectLevel('.motor-select-tag', '#motorLabel');
            @endif
            @if(isset($_GET['enginesize']))
                setSelectLevel('.enginesize-select-tag', '#enginesizeLabel');
            @endif
            @if(isset($_GET['year']))
                setSelectLevel('.year-select-tag', '#yearLabel');
            @endif
            @if(isset($_GET['category']))
                setSelectLevel('.category-select-tag', '#categoryLabel');
            @endif
        })

        function setSelectLevel(selectTagSelector, levelSelector) {
