...
{{--                    <span onclick="changeLocalLang('en')" class="{{ !Session::has('locale') || Session::get('locale') == 'en' ? 'active' : ''}}">EN</span>--}}
{{--                    <span onclick="changeLocalLang('bn')" class="{{ Session::has('locale') && Session::get('locale') == 'bn' ? 'active' : ''}}">BN</span>--}}
                </div>
            </div>
